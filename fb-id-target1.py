...
"SELAMAT-DATANG"
DI-TERMUX-FACEBOOK-NHK-46
HACK FB ID ACAK TARGET PASSWORD
KALIAN BISA BUAT ACAK NAMA
PASSWORD EDIT DENGAN TXT.
BY:= NHK-46

1.python2 fb-id-target1.py
2.python2 fb-id-target2.py

password:
3./sdcard/fb-id-target.txt

ID:= TARGET

PASSWORD:= /sdcard/fb-id-target.txt

tinggal menunggu proses hack password.
